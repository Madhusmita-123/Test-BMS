...
namespace BMS.Models
{
    ...
    public partial class TransCap_Wrk__LeveL_ApprovalNonInvoice
    {
        public int Cap_wrk_CashReqAprv_levelIdNoninvoice { get; set; }
        public Nullable<int> Cap_wrk_CashReq_NonInvoiceId { get; set; }
